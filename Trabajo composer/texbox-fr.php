...
$tr = new GoogleTranslate(fr); // Traducir Frances


$textoes = 'Escribe texto para traducir';
$textoen = 'Write text to translate';
$textoch = '写文字翻译';
$textofr = 'Écrire du texte à traduire';
$textoeus = 'Idatzi testua itzultzeko';
...
<div class="cuadro">
<form action="texbox-fr.php" method="post">
...
<div class="cuadro2">
<form action="texbox.php" method="post">
